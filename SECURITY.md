...
- **Run the [reference validator](validator/) before playing** a file you didn't create — it rejects structurally broken modules, though it is not a security sandbox on its own.
